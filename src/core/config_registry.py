...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "EXTENSIONS_ALPHASIFT_ENABLED": {
        ...
        "description": "Enable the built-in AlphaSift candidate discovery plugin.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "ALPHASIFT_API_URL": {
        "title": "AlphaSift API URL",
        "description": "Optional remote AlphaSift HTTP service URL. Used only when the local Python package is unavailable.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "ALPHASIFT_CLI_PATH": {
        "title": "AlphaSift CLI Path",
        "description": "AlphaSift CLI binary path. Used only when AlphaSift CLI fallback is explicitly enabled.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "alphasift",
        "options": [],
        "validation": {"max_length": 120},
        "display_order": 60,
    },
    "EXTENSIONS_ALPHASIFT_CLI_FALLBACK_ENABLED": {
        "title": "AlphaSift CLI Fallback Enabled",
        "description": "Allow DSA to call the AlphaSift CLI for screen fallback. Disabled by default until the local CLI flags are verified.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "ALPHASIFT_SNAPSHOT_SOURCE_PRIORITY": {
        "title": "AlphaSift Snapshot Source Priority",
        "description": "Comma-separated market snapshot source priority passed to the AlphaSift Python adapter.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "em_datacenter,efinance,akshare_em",
        "options": [],
        "validation": {"max_length": 160},
        "display_order": 62,
    },
    "EXTENSIONS_ALPHASIFT_TIMEOUT_SECONDS": {
        "title": "AlphaSift Timeout Seconds",
        "description": "Outer timeout for AlphaSift actions. Python calls cannot be force-killed after timeout.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "default_value": "180",
        "options": [],
        "validation": {"min": 30, "max": 900},
        "display_order": 63,
    },
    "EXTENSIONS_CLI_STDOUT_MAX_BYTES": {
        "title": "Extension CLI Stdout Limit",
        "description": "Maximum stdout bytes read from extension CLI adapters before returning E_OUTPUT_TOO_LARGE.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "EXTENSIONS_CLI_STDERR_MAX_BYTES": {
        "title": "Extension CLI Stderr Limit",
        "description": "Maximum stderr bytes read from extension CLI adapters before returning E_OUTPUT_TOO_LARGE.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
