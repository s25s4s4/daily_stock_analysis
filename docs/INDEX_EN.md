...
| [Extension Runtime Contract](extensions.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | P0/P1 plugin contract, Action Runtime, permission guards, task metadata, and AlphaSift phase boundaries |
| [AlphaSift Integration](alphasift-integration.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | AlphaSift plugin enablement, adapter behavior, actions, config keys, and P2 phase boundaries |
