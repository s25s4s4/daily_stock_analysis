...
| [Extension Runtime 与插件化契约](extensions.md) | P0/P1 插件契约、Action Runtime、权限守卫、任务元数据和 AlphaSift 批次边界 |
| [AlphaSift 集成说明](alphasift-integration.md) | AlphaSift 插件启用、adapter、Action、配置项和 P2 阶段边界 |
